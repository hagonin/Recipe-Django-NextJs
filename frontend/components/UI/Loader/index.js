		...
		case 'single-recipe':
			return (
				<div className="animate-pulse mb-8">
					<div className="h-7 bg-gray-300 rounded-md max-w-[640px] mb-2.5 mx-auto"></div>
					<div className="h-3 bg-gray-300 rounded-md w-32 mb-2.5 mx-auto"></div>
					...
					<div className="h-10 bg-gray-300 rounded-md mb-2.5 mx-auto"></div>
				</div>
			);
		case 'submitting':
			return (
